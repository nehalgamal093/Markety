...
@Composable
fun RegisterTab(viewModel: RegisterViewModel = viewModel(), navController: NavController) {
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        AuthTextField("Email", "Type your email", value = state.email, viewModel::updateEmail)
